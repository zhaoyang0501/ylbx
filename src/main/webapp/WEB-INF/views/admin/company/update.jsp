...
<script type="text/javascript">
	function getCompany(){
		$.ajax({
			type : "get",
			url : $.ace.getContextPath() + "/admin/company/get?id="+$("#companyid").val(),
			dataType : "json",
			success : function(json) {
				if(json.resultMap.state=='success'){
					alert(json.resultMap.object.address);
					$("input[name='company.address']").val(json.resultMap.object.address);
					...
					<div class="content-widgets light-gray">
						...
						<div class="widget-container">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name='company.id'  id='companyid' type="text" placeholder="" >
										  <button type="button" class="btn" onclick="getCompany()">查询</button>
									</div>
								</div>
								<div class="control-group">
